...
class WarenkorbApi
{
     ...
     *
     * @param  string $cart_identifier Warenkorb ID (required)
     * @param  \Mittwald\Api\Model\EMailDaten $payload payload (required)
     *
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Mittwald\Api\Model\Cart
     */
    public function recommendCart($cart_identifier, $payload)
    {
        list($response) = $this->recommendCartWithHttpInfo($cart_identifier, $payload);
        return $response;
    }
     ...
     *
     * @param  string $cart_identifier Warenkorb ID (required)
     * @param  \Mittwald\Api\Model\EMailDaten $payload (required)
     *
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mittwald\Api\Model\Cart, HTTP status code, HTTP response headers (array of strings)
     */
    public function recommendCartWithHttpInfo($cart_identifier, $payload)
    {
        $returnType = '\Mittwald\Api\Model\Cart';
        $request = $this->recommendCartRequest($cart_identifier, $payload);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recommendCartAsync($cart_identifier, $payload)
    {
        return $this->recommendCartAsyncWithHttpInfo($cart_identifier, $payload)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recommendCartAsyncWithHttpInfo($cart_identifier, $payload)
    {
        $returnType = '\Mittwald\Api\Model\Cart';
        $request = $this->recommendCartRequest($cart_identifier, $payload);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function recommendCartRequest($cart_identifier, $payload)
    {
        // verify the required parameter 'cart_identifier' is set
        if ($cart_identifier === null || (is_array($cart_identifier) && count($cart_identifier) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($payload === null || (is_array($payload) && count($payload) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payload when calling recommendCart'
            );
        }
