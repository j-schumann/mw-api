...
class VertrgeApi
{
     ...
     * Kündigung einleiten
     *
     * @param  \Mittwald\Api\Model\CancellationRequest $body Die Kündigungsdaten (required)
     *
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function cancelContract($body)
    {
        $this->cancelContractWithHttpInfo($body);
    }
     ...
     */
    public function cancelContractWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->cancelContractRequest($body);
     ...
     */
    public function cancelContractAsync($body)
    {
        return $this->cancelContractAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelContractAsyncWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->cancelContractRequest($body);
     ...
     */
    protected function cancelContractRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling cancelContract'
            );
        }
