...
class DatabaseApi
{
     ...
     * @return \Mittwald\Api\Model\DatabaseType[]
     */
     ...
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mittwald\Api\Model\DatabaseType[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listDatabaseTypesWithHttpInfo()
    {
        $returnType = '\Mittwald\Api\Model\DatabaseType[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mittwald\Api\Model\DatabaseType[]',
