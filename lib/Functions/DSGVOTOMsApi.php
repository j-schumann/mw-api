...
class DSGVOTOMsApi
{
     ...
     * TOM - TOM anlegen
     *
     * @param  \Mittwald\Api\Model\GDPRTom $body Die Daten des Toms (required)
     *
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Mittwald\Api\Model\GDPRTom
     */
    public function createGDPRTom($body)
    {
        list($response) = $this->createGDPRTomWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function createGDPRTomWithHttpInfo($body)
    {
        $returnType = '\Mittwald\Api\Model\GDPRTom';
        $request = $this->createGDPRTomRequest($body);
     ...
     */
    public function createGDPRTomAsync($body)
    {
        return $this->createGDPRTomAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createGDPRTomAsyncWithHttpInfo($body)
    {
        $returnType = '\Mittwald\Api\Model\GDPRTom';
        $request = $this->createGDPRTomRequest($body);
     ...
     */
    protected function createGDPRTomRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createGDPRTom'
            );
        }
