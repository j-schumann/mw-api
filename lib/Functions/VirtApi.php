...
class VirtApi
{
    ...
    /**
     * Operation listGuestOperatingSystems
     *
     ...
     * @return \Mittwald\Api\Model\GuestOperatingSystem
     */
    public function listGuestOperatingSystems()
    {
        list($response) = $this->listGuestOperatingSystemsWithHttpInfo();
        return $response;
    }

    /**
     * Operation listGuestOperatingSystemsWithHttpInfo
     *
     * Root-Server Betriebssysteme
     *
     *
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mittwald\Api\Model\GuestOperatingSystem, HTTP status code, HTTP response headers (array of strings)
     */
    public function listGuestOperatingSystemsWithHttpInfo()
    {
        $returnType = '\Mittwald\Api\Model\GuestOperatingSystem';
        $request = $this->listGuestOperatingSystemsRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mittwald\Api\Model\GuestOperatingSystem',
    ...
    /**
     * Operation listGuestOperatingSystemsAsync
     *
     * Root-Server Betriebssysteme
     *
     *
     ...
     */
    public function listGuestOperatingSystemsAsync()
    {
        return $this->listGuestOperatingSystemsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listGuestOperatingSystemsAsyncWithHttpInfo
     *
     * Root-Server Betriebssysteme
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listGuestOperatingSystemsAsyncWithHttpInfo()
    {
        $returnType = '\Mittwald\Api\Model\GuestOperatingSystem';
        $request = $this->listGuestOperatingSystemsRequest();
    ...
    /**
     * Create request for operation 'listGuestOperatingSystems'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listGuestOperatingSystemsRequest()
    {

        $resourcePath = '/virt/guestoperatingsystems';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
