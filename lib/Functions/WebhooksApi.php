...
class WebhooksApi
{
     ...
     *
     * @param  \Mittwald\Api\Model\Webhook $body Die Webhook-Konfiguration (required)
     *
     ...
     * @return \Mittwald\Api\Model\Webhook
     */
    public function updateWebhook($body, $webhook_identifier)
    {
        list($response) = $this->updateWebhookWithHttpInfo($body, $webhook_identifier);
        return $response;
    }
     ...
     * @return array of \Mittwald\Api\Model\Webhook, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWebhookWithHttpInfo($body, $webhook_identifier)
    {
        $returnType = '\Mittwald\Api\Model\Webhook';
        $request = $this->updateWebhookRequest($body, $webhook_identifier);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsync($body, $webhook_identifier)
    {
        return $this->updateWebhookAsyncWithHttpInfo($body, $webhook_identifier)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsyncWithHttpInfo($body, $webhook_identifier)
    {
        $returnType = '\Mittwald\Api\Model\Webhook';
        $request = $this->updateWebhookRequest($body, $webhook_identifier);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateWebhookRequest($body, $webhook_identifier)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
