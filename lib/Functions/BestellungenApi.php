...
class BestellungenApi
{
     ...
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Mittwald\Api\Model\OrderPreUpgradeCheck
     */
     ...
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mittwald\Api\Model\OrderPreUpgradeCheck, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderPreUpgradeCheckWithHttpInfo($account_identifier, $article_number)
    {
        $returnType = '\Mittwald\Api\Model\OrderPreUpgradeCheck';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mittwald\Api\Model\OrderPreUpgradeCheck',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function orderPreUpgradeCheckRequest($account_identifier, $article_number)
    {
