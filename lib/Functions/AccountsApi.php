...
class AccountsApi
{
     ...
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Mittwald\Api\Model\StorageStatistics
     */
    public function getAccountStatistics($account_identifier)
    {
        list($response) = $this->getAccountStatisticsWithHttpInfo($account_identifier);
        return $response;
    }

    /**
     * Operation getAccountStatisticsWithHttpInfo
     *
     * @param  string $account_identifier Name oder ID eines Accounts (required)
     *
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mittwald\Api\Model\StorageStatistics, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAccountStatisticsWithHttpInfo($account_identifier)
    {
        $returnType = '\Mittwald\Api\Model\StorageStatistics';
        $request = $this->getAccountStatisticsRequest($account_identifier);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mittwald\Api\Model\StorageStatistics',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getAccountStatisticsAsync
     *
     * 
     *
     * @param  string $account_identifier Name oder ID eines Accounts (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountStatisticsAsync($account_identifier)
    {
        return $this->getAccountStatisticsAsyncWithHttpInfo($account_identifier)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAccountStatisticsAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $account_identifier Name oder ID eines Accounts (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountStatisticsAsyncWithHttpInfo($account_identifier)
    {
        $returnType = '\Mittwald\Api\Model\StorageStatistics';
        $request = $this->getAccountStatisticsRequest($account_identifier);
    ...
    /**
     * Create request for operation 'getAccountStatistics'
     *
     * @param  string $account_identifier Name oder ID eines Accounts (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAccountStatisticsRequest($account_identifier)
    {
        // verify the required parameter 'account_identifier' is set
        if ($account_identifier === null || (is_array($account_identifier) && count($account_identifier) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_identifier when calling getAccountStatistics'
            );
        }

        $resourcePath = '/accounts/{accountIdentifier}/stats';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getAccountVisitorStatistics
     *
     * @param  string $account_identifier Name oder ID eines Accounts (required)
     *
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Mittwald\Api\Model\VisitorStatistics
     */
    public function getAccountVisitorStatistics($account_identifier)
    {
        list($response) = $this->getAccountVisitorStatisticsWithHttpInfo($account_identifier);
        return $response;
    }

    /**
     * Operation getAccountVisitorStatisticsWithHttpInfo
     *
     * @param  string $account_identifier Name oder ID eines Accounts (required)
     *
     * @throws \Mittwald\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mittwald\Api\Model\VisitorStatistics, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAccountVisitorStatisticsWithHttpInfo($account_identifier)
    {
        $returnType = '\Mittwald\Api\Model\VisitorStatistics';
        $request = $this->getAccountVisitorStatisticsRequest($account_identifier);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mittwald\Api\Model\VisitorStatistics',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getAccountVisitorStatisticsAsync
     *
     * 
     *
     * @param  string $account_identifier Name oder ID eines Accounts (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountVisitorStatisticsAsync($account_identifier)
    {
        return $this->getAccountVisitorStatisticsAsyncWithHttpInfo($account_identifier)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAccountVisitorStatisticsAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $account_identifier Name oder ID eines Accounts (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountVisitorStatisticsAsyncWithHttpInfo($account_identifier)
    {
        $returnType = '\Mittwald\Api\Model\VisitorStatistics';
        $request = $this->getAccountVisitorStatisticsRequest($account_identifier);
    ...
    /**
     * Create request for operation 'getAccountVisitorStatistics'
     *
     * @param  string $account_identifier Name oder ID eines Accounts (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAccountVisitorStatisticsRequest($account_identifier)
    {
        // verify the required parameter 'account_identifier' is set
        if ($account_identifier === null || (is_array($account_identifier) && count($account_identifier) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_identifier when calling getAccountVisitorStatistics'
            );
        }

        $resourcePath = '/accounts/{accountIdentifier}/stats/visitors';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
