...
class Contact implements ModelInterface, ArrayAccess
{
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Contact., must be bigger than or equal to 1.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if ((strlen($street) < 1)) {
            throw new \InvalidArgumentException('invalid length for $street when calling Contact., must be bigger than or equal to 1.');
        }
    ...
    public function setHouseNumber($house_number)
    {
        ...
        if ((strlen($house_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $house_number when calling Contact., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Contact., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling Contact., must be smaller than or equal to 2.');
        }
        if ((strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling Contact., must be bigger than or equal to 2.');
        }
