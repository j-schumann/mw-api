...
class UpdateContact implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['house_number']) && (strlen($this->container['house_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'house_number', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['city']) && (strlen($this->container['city']) < 1)) {
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    {
        $allowedValues = $this->getSalutationAllowableValues();
        if (!is_null($salutation) && !in_array($salutation, $allowedValues)) {
    ...
    public function setStreet($street)
    {
        ...
        if (!is_null($street) && (strlen($street) < 1)) {
            throw new \InvalidArgumentException('invalid length for $street when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    public function setHouseNumber($house_number)
    {
        ...
        if (!is_null($house_number) && (strlen($house_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $house_number when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (!preg_match("/^\\+([0-9]{2,3}|1)\\-[0-9]{2,5}\\-[0-9]+$/", $phone))) {
            throw new \InvalidArgumentException("invalid value for $phone when calling UpdateContact., must conform to the pattern /^\\+([0-9]{2,3}|1)\\-[0-9]{2,5}\\-[0-9]+$/.");
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling UpdateContact., must be smaller than or equal to 2.');
        }
        if (!is_null($country) && (strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling UpdateContact., must be bigger than or equal to 2.');
        }
