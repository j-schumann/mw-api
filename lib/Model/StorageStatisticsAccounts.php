...
/**
 * StorageStatisticsAccounts Class Doc Comment
 *
 * @category Class
 * @package  Mittwald\Api
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StorageStatisticsAccounts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StorageStatistics_accounts';
    ...
    protected static $swaggerTypes = [
        'details' => '\Mittwald\Api\Model\StorageStatisticsDetails',
        'limit' => 'float',
        'name' => 'string',
        'percent' => 'float',
        'summary' => 'float'
     ...
     * Gets details
     *
     * @return \Mittwald\Api\Model\StorageStatisticsDetails
     */
     ...
     * Sets details
     *
     * @param \Mittwald\Api\Model\StorageStatisticsDetails $details details
     *
     * @return $this
     */
     ...
     * Sets limit
     *
     * @param float $limit Speicherplatzbeschränkung des Projekts
     *
     * @return $this
     */
     ...
     * Sets summary
     *
     * @param float $summary Absolute Speicherplatzverbrauch des Projekts, in KiB
     *
     * @return $this
     */
