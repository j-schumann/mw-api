...
/**
 * StorageStatisticsItem Class Doc Comment
 *
 * @category Class
 * @package  Mittwald\Api
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StorageStatisticsItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StorageStatisticsItem';
    ...
    protected static $setters = [
        ...
        'item_updated_at' => 'setItemUpdatedAt'
    ];
    ...
    protected static $getters = [
        ...
        'item_updated_at' => 'getItemUpdatedAt'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['item_size'] = isset($data['item_size']) ? $data['item_size'] : null;
        $this->container['item_updated_at'] = isset($data['item_updated_at']) ? $data['item_updated_at'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['item_updated_at'] === null) {
            $invalidProperties[] = "'item_updated_at' can't be null";
        }
     ...
     * Sets item_size
     *
     * @param float $item_size Speicherplatzverbrauch in KiB
     *
     * @return $this
     */
    ...
    /**
     * Gets item_updated_at
     *
     * @return float
     */
    public function getItemUpdatedAt()
    {
        return $this->container['item_updated_at'];
    }

    /**
     * Sets item_updated_at
     *
     * @param float $item_updated_at Letzter Änderungszeitpunkt, als UNIX-Zeitstempel in Sekunden.
     *
     * @return $this
     */
    public function setItemUpdatedAt($item_updated_at)
    {
        $this->container['item_updated_at'] = $item_updated_at;
