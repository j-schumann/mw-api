...
/**
 * SendMailForGDPRContractRequest Class Doc Comment
 *
 * @category Class
 * @package  Mittwald\Api
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SendMailForGDPRContractRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sendMailForGDPRContractRequest';
    ...
    {
        $this->container['mail_to'] = isset($data['mail_to']) ? $data['mail_to'] : null;
    ...
    {
        return $this->container['mail_to'];
    }

    /**
     * Sets mail_to
     *
     * @param string $mail_to Falls eine vom hinterlegten Kontakt abweichende Empfänger E-Mail Adresse angegeben werden soll
     *
     * @return $this
     */
    public function setMailTo($mail_to)
    {
        $this->container['mail_to'] = $mail_to;
     ...
     * Sets content
     *
     * @param string $content Falls ein spezifischer Inhalt anstelle des Standard E-Mail Inhalts versendet werden soll. Dabei kann mit Hilfe der Zeichenkette {{link}} der Bestätigungslink eingefügt werden.
     *
     * @return $this
     */
