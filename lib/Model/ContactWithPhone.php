 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContactWithPhone implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['title']) && (strlen($this->container['title']) < 1)) {
        ...
        if ((strlen($this->container['house_number']) < 1)) {
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling ContactWithPhone., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling ContactWithPhone., must be bigger than or equal to 1.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ContactWithPhone., must be bigger than or equal to 1.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if ((strlen($street) < 1)) {
            throw new \InvalidArgumentException('invalid length for $street when calling ContactWithPhone., must be bigger than or equal to 1.');
        }
    ...
    public function setHouseNumber($house_number)
    {
        ...
        if ((strlen($house_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $house_number when calling ContactWithPhone., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ContactWithPhone., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling ContactWithPhone., must be smaller than or equal to 2.');
        }
        if ((strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling ContactWithPhone., must be bigger than or equal to 2.');
        }
